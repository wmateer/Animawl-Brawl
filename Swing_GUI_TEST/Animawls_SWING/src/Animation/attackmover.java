...
public class attackmover extends JLabel implements ActionListener
{
    int deltaX = 2;
    int deltaY = 3;
    int directionX = 1;
    ...
    public attackmover(String imgPath,int startX, int startY,int deltaX, int deltaY,int directionX, int directionY,int delay)
    {
        this.deltaX = deltaX;
        this.deltaY = deltaY;
...
//      frame.getContentPane().add( new TimerAnimation(0, 000, 5, 0, 1, 1, 20) );
        frame.getContentPane().add( new attackmover("IMAGES/ANIMATION_TEST/frame0.png",0, 200, 5, 0, 1, 1, 80) );
